        ...
        <div class="" style="padding-top: 150px;padding-bottom: 150px;padding-left: 15%;padding-right: 15%;">
            ...
            <div class="card">
                <form class="text-center border border-light p-5" action="#!" style="background-color: lightgoldenrodyellow;" >
                    ...
                    <input type="tel" id="lastName" class="form-control mb-4" placeholder="Contact Number">
                    <!-- <input type="number" id="leasing amount" class="form-control mb-4" placeholder="leasing amount"> -->
                    <!-- <input type="date" id="terms" class="form-control mb-4" placeholder="terms"> -->
                    ...
                    <div style="padding-top: 10px;">
                        <button class="btn btn-info btn-block" type="submit">Button Submit</button>
                    </div>
