        ...
        <div class="row" style="padding-top: 2%;padding-bottom: 2%;">
            <div class="col-md-7 col-12 productimg" style="">
                <div class="row" >
                    <div class="col-12">
                        <div class="row">
                            <div class="col-4" style="height: 30px;"><h3 style="font-weight: bold;">pamal 1</h3></div>
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" style="margin-bottom:20px" src="images/featured_1.png" alt="third slide">

                                            <div style="background-color:red; padding:10px 20px">
                                                <ol style="margin=30px;">
                                                    <li>Agent Name: </li>
                                                    <li>Leasing Company Name:</li>
                                                    <li>Leasing Amount:</li>
                                                    <li >term:
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" style="margin-bottom:20px" src="images/featured_6.png" alt="Second slide">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" style="margin-bottom:20px" src="images/featured_3.png" alt="First slide">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" style="margin-bottom:20px" src="images/featured_3.png" alt="Third slide">
