        ...
        <div class="col-6" style="padding-top: 150px;padding-bottom: 150px;;">
            ...
            <div class="card">
                <form class="text-center border border-light p-5" action="#!" style="background-color: lightgoldenrodyellow;">
                    ...
                    <input type="text" id="lastName" class="form-control mb-4" placeholder="Leasing company/Bank name">

                    <!-- <input type="number" id="lastName" class="form-control mb-4" placeholder="Company Id Number"> -->
                    <div class="form-row">
                        <div class="col">
                            <!-- <label>Company Id card</label> -->
                            <input type="text" id="companyId"  disabled class="form-control mb-4" placeholder="Company Id card">
...
<?php /**PATH C:\project\auction.lk\Laravel\resources\views/leasingAgentForm.blade.php ENDPATH**/ ?>