            ...
            <div class="col-sm-4 col-12">
                <div class="packagecard">
                    <div class="containerx card">
                        ...
                        <div><a><a class="btn btn-outline-warning" href="<?php echo e(url('insuranceAgentForm')); ?>" style="margin:20px;" data-toggle="tooltip" title="500/MONTH">Get Started</a></a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 col-12">
                <div class="packagecard">
                    <div class="containerx card">
                        ...
                        <div class="footer_phone">sms billing access</div>
                        <div class="cardtext" style="text-align: justify">//ones you post your client ad .cliant will recive thank you massage with payment verified sms .you don’t need worry about manual recipt .you can collect payment from client ones client recive sms</div>
                        <div><a><a class="btn btn-outline-warning" href="<?php echo e(url('insuranceAgentForm')); ?>" style="margin:20px;" data-toggle="tooltip" title="1000/MONTH">Get Started</a></a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 col-12">
                <div class="packagecard">
                    <div class="containerx card">
                        ...
                        <div class="footer_phone">sms billing access</div>
                        <div class="cardtext" style="text-align: justify">//ones you post your client ad .cliant will recive thank you massage with payment verified sms .you don’t need worry about manual recipt .you can collect payment from client ones client recive sms</div>
                        <div><a><a class="btn btn-outline-warning" href="<?php echo e(url('insuranceAgentForm')); ?>" style="margin:20px;" data-toggle="tooltip" title="2000/MONTH">Get Started</a></a></div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\project\auction.lk\Laravel\resources\views/insuranceAgent.blade.php ENDPATH**/ ?>